...
def get_parser():
    ...
    # ─────────────────────────────────────────────────────────────────────────────────────────────────
    exp_parser.add_argument('--mode_name', default="Seed1_1_TDM_NoRotation_Last4Layer", type=str,
        choices=[
    ...
    exp_parser.add_argument('--tdm_num_layers', default=4, type=int, help='Number of decoder layers enhanced with TDM')                                            # 🎀📣 3
