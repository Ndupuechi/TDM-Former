...
def save_model_summary(
    ...
    if exp_args.net == "TDM_Former":
        ...
        model_summary.append(
        f"🔧 tdm_alpha= "
        f"{exp_args.tdm_alpha} | "
        f"🔧 tdm_transition_amplification= "
        f"{exp_args.tdm_transition_amplification} | "
        f"🔧 tdm_num_layers= "
        f"{exp_args.tdm_num_layers} | "
        f"⏪⏭️ tdm_insertion_type= "
        f"{exp_args.tdm_insertion_type}"
        )
