...
def get_parser():
    ...
    exp_parser.add_argument('--mode_name', default="Seed1_1_TDM_NoRotation_Last2Layer", type=str,
        choices=[
            ...
            # ────────────────────────────────────────────────────────────────────────
            "Seed1_1_Baseline_Transformer ➡️ Seed1_1_EXP3",
    ...
    #--------------------------------------------------------------------------------------------------
    exp_parser.add_argument('--tdm_register_module', default=True, type=bool, help='Register TDM as decoder module for architecture visibility and parameter tracking')   
    ...
    exp_parser.add_argument('--run_efficiency_test', default=True, type=bool, help='If True → run inference efficiency test for throughput, inference time, and GPU memory.')
    # ─────────────────────────────────────────────────────────────────────────────────────────────────
