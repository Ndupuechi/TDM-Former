...
Project_PATH = r"C:\Users\emeka\Research\ModelCUDA\Transformers\AblationStudy_IT_EN"
...
# ────────────────────────────────────────────────────────────────────────────────────────────────
# 1️⃣✅ Import parser from parser_IWSLT17It_En.py
from parser_IWSLT17It_En import get_parser
...
from fairseq_config_IWSLT17It_En import get_fairseq_parser
...
########################################################################################################################
########################################################################################################################
####-------| NOTE 3.1. PROCESSING DATASET 1 | XXX ------------| ITALY→ENGLISH |---------------------####################
########################################################################################################################

"""
Stage 1:
Train SentencePiece tokenizer, encode the raw Italy→English corpus,
...
if exp_args.run_dataset_tokenization:
    ...
    # ===============================================================================================
    # 1️⃣ Download / load IWSLT17 IT→EN from Hugging Face
    # ===============================================================================================
    DATA_PATH = r"C:\Users\emeka\Research\ModelCUDA\Transformers\AblationStudy_IT_EN\Dataset\en-it\en-it"
    os.makedirs(DATA_PATH, exist_ok=True)

    print("📥 Downloading/loading IWSLT17 IT↔EN dataset...")
    ...
    # ===============================================================================================
    SRC_IT = os.path.join(DATA_PATH, "train.it")
    ...
    assert os.path.exists(SRC_IT), f"Missing: {SRC_IT}"
    ...
    # ===============================================================================================
    print("🧠 Training SentencePiece model for IT→EN...")

    spm_model_prefix = os.path.join(DATA_PATH, "spm_iten")

    spm.SentencePieceTrainer.Train(
        # input=f"{SRC_EN},{TGT_IT}",
        input=f"{SRC_IT},{TGT_EN}",
    ...
    encode_file(SRC_IT, os.path.join(DATA_PATH, "train.spm.it"))
    ...
    print("✅ IT→EN SentencePiece encoding complete")
...
########################################################################################################################
########################################################################################################################
####-------| NOTE 3.2. PROCESSING DATASET 2 | XXX ------------| ITALY→ENGLISH |---------------------####################
########################################################################################################################

"""
Stage 2:
Preprocess the tokenized Italy→English dataset using fairseq-preprocess
...
if exp_args.run_fairseq_preprocessing:
    ...
    DATA_DIR = r"C:\Users\emeka\Research\ModelCUDA\Transformers\AblationStudy_IT_EN\en-it\en-it"


    print("🚀 Running fairseq-preprocess IWSLT17 IT→EN")
    ...
    cmd = [
        ...
        "--destdir", "data-bin/iwslt17.it-en",
    ...
    print("✅ data-bin/iwslt17.it-en created")
    # ─────────────────────────────────────────────────────────────────────────────────────────────────
    # ─────────────────────────────────────────────────────────────────────────────────────────────────
...
# ✅✅ Print translation direction (IT→EN confirmation)
