...
**TDM-Former: Transition Dynamics Modulation-Enhanced Transformer Decoder Feed-Forward Networks for Neural Machine Translation**
...
## Decoder FFN ResBlock Architectures

The conventional Transformer decoder FFN ResBlock contains a position-wise FFN with two fully connected linear sublayers and an activation function. Each FFN output is computed from the corresponding activated FFN representation without directly using the preceding activated FFN representation.

The proposed TDM-enhanced decoder FFN ResBlock incorporates TDM between the FFN activation and the second linear transformation. TDM computes a transition signal between consecutive activated FFN representations and uses this signal to modulate the current activated FFN representation.
...
<table>
  ...
  <tr>
    <td align="center">
      <b>Figure: Baseline Decoder FFN ResBlock</b>
    </td>
    <td align="center">
      <b>Figure: TDM-enhanced Decoder FFN ResBlock</b>
    </td>
  </tr>
</table>
...
- [Baseline Decoder FFN ResBlock](1-Architecture/ffn_resblock.pdf)
- [TDM-Enhanced Decoder FFN ResBlock](1-Architecture/ffn_tdm_resblock.pdf)
