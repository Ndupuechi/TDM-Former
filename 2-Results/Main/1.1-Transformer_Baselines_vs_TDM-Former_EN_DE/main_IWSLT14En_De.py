...
Project_PATH = r"C:\Users\emeka\Research\ModelCUDA\Transformers\Transformer_Baselines_EN_DE"
...
# ────────────────────────────────────────────────────────────────────────────────────────────────
# 1️⃣✅ Import parser from parser_IWSLT13En_Fr.py
from parser_IWSLT14En_De import get_parser
...
from fairseq_config_IWSLT14En_De import get_fairseq_parser
...
########################################################################################################################
########################################################################################################################
####-------| NOTE 3.1. PROCESSING DATASET 1 | XXX ------------| ENGLISH→GERMAN |--------------------####################
########################################################################################################################

"""
Stage 1:
Train SentencePiece tokenizer, encode the raw English→German corpus,
...
if exp_args.run_dataset_tokenization:
    ...
    # ─────────────────────────────────────────────────────────────────────────────────────────────────
    # ✅ Path for EN→DE dataset
    DATA_PATH = r"C:\Users\emeka\Research\ModelCUDA\Transformers\Transformer_Baselines_EN_DE\Dataset\en-de\de-en"
    ...
    # ─────────────────────────────────────────────────────────────────────────────────────────────────
    SRC_EN = os.path.join(DATA_PATH, "train.tags.de-en.en")
    TGT_DE = os.path.join(DATA_PATH, "train.tags.de-en.de")

    assert os.path.exists(SRC_EN), f"Missing: {SRC_EN}"
    assert os.path.exists(TGT_DE), f"Missing: {TGT_DE}"

    print("✅ Using official IWSLT14 training files")
    print(f"🇬🇧 English: {SRC_EN}")
    print(f"🇩🇪 German : {TGT_DE}")
    # ─────────────────────────────────────────────────────────────────────────────────────────────────
    ...
    # ─────────────────────────────────────────────────────────────────────────────────────────────────
    print("🧠 Training SentencePiece model for EN→DE...")

    spm_model_prefix = os.path.join(DATA_PATH, "spm_ende")

    spm.SentencePieceTrainer.Train(
        input=f"{SRC_EN},{TGT_DE}",
...
########################################################################################################################
########################################################################################################################
####-------| NOTE 3.2. PROCESSING DATASET 2 | XXX ------------| ENGLISH→FRENCH |--------------------####################
########################################################################################################################

"""
Stage 2:
Preprocess the tokenized English→German dataset using fairseq-preprocess
...
if exp_args.run_fairseq_preprocessing:
    ...
    DATA_DIR = r"C:\Users\emeka\Research\ModelCUDA\Transformers\Transformer_Baselines_EN_DE\Dataset\en-de\de-en"
    ...
    print("🚀 Running fairseq-preprocess for EN→DE...")
    ...
    cmd = [
        ...
        "--destdir", "data-bin/iwslt14.en-de",
        "--workers", "8"
    ]
    ...
    print("✅ Preprocessing complete! Binarized EN→DE data saved in data-bin/iwslt14.en-de")
    # ─────────────────────────────────────────────────────────────────────────────────────────────────
    # ─────────────────────────────────────────────────────────────────────────────────────────────────
