...
#####-------------------------------- NOTE PARSER IWSLT17 RO-EN NOTE ------------------------------------------------#####
##########################################################################################################################
######################|--------------------------------------------------------------|####################################
############################################# IWSLT17 RO-EN ##############################################################
######################|--------------------------------------------------------------|####################################
...
def get_parser():
    ...
    # ─────────────────────────────────────────────────────────────────────────────────────────────────
    # ✅ ============================= IWSLT17Ro-En Training Hyperparameters ==========================
    # ─────────────────────────────────────────────────────────────────────────────────────────────────
    exp_parser = argparse.ArgumentParser(description='IWSLT17 RO-EN Experiment Config')
    ...
    exp_parser.add_argument('--dataset_name', default="IWSLT17_Ro_En", type=str,
    ...
    # ─────────────────────────────────────────────────────────────────────────────────────────────────
    exp_parser.add_argument('--rtm_alpha', default=0.05, type=float, help='RTM rotational modulation strength')                                  # 🎀📣 0.05
    exp_parser.add_argument('--rtm_transition_amplification', default=4.5, type=float, help='RTM transition-conditioned amplification factor')   # 🎀📣 4.5
    exp_parser.add_argument('--rtm_num_layers', default=3, type=int, help='Number of decoder layers enhanced with RTM')                          # 🎀📣 3
    exp_parser.add_argument('--rtm_insertion_type', default='ffn', type=str, choices=['ffn', 'ffn_depth_weighted', 'cross_attn', 'aurtm', 'sartm'], help='RTM insertion location')           # 🎀📣 ffn
    #--------------------------------------------------------------------------------------------------
    ...
    #--------------------------------------------------------------------------------------------------
    exp_parser.add_argument('--rtm_layer_scale_direction', default='reverse_final_fixed', type=str, choices=['forward', 'reverse', 'reverse_final_fixed'], help='Direction of depth-weighted RTM scaling')   # 🎀📣 reverse_final_fixed
    exp_parser.add_argument('--rtm_layer_scale_min', default=0.70, type=float, help='Minimum RTM depth scale for lowest RTM-enhanced decoder layer')   # 🎀📣 0.70
    exp_parser.add_argument('--rtm_final_layer_scale', default=0.35, type=float, help='Fixed RTM scale for final enhanced decoder layer')              # 🎀📣 0.35
    #-------------------------------------------------------------------------------------------------- 
    ...
    # ─────────────────────────────────────────────────────────────────────────────────────────────────
    exp_parser.add_argument('--crash_run', default=False, type=bool, help='False: reset test result file | True: continue after crash and append results')
    # ─────────────────────────────────────────────────────────────────────────────────────────────────
